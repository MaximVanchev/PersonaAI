...
export function GenerateForm() {
    ...
    return (
        <form className="w-full justify-center sm:w-auto mx-auto flex flex-col gap-4">
                    ...
                    <button type="submit" className={ maleCount + femaleCount > 6 || maleCount + femaleCount < 1 ? "cursor-not-allowed opacity-50 py-3" : "py-3" } disabled={ maleCount + femaleCount > 6 || maleCount + femaleCount < 1 }>
                      Generate
                    </button>
                    </div>
                  </form>
